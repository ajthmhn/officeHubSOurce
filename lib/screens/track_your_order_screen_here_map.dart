...
// Map storing polylines created by connecting two points
        ...
        timer = Timer.periodic(
          ...
          if (mounted) {
            setState(() {
              ...
              current_lat = _currentLatitude;
              current_lang = _currentLongitude;
  ...
  void callStartTracking(int orderId) {
    print('stattracking fun calling');
    RestClient(Retro_Api().Dio_Data()).tracking(orderId).then((response) {
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: ApplicationToolbar_WithClrBtn(
          appbarTitle: '',
          str_button_title: Languages.of(context).labelViewOrderDetails,
