            ...
            return Column(
              ...
              children: [
                          ...
                          child: Padding(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  hintStyle:
                                  TextStyle(color: Color(Constants.color_hint)),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                'Forgot Password ?',
                                style: TextStyle(
                                    fontSize: 16.0, fontFamily: Constants.app_font),
                              ),
                            )
                          ],
                        ),
                        ...
                        Row(
                          children: [
                            ...
                            Text(
                              'Remember Me',
                              style: TextStyle(
                                  fontSize: 14.0, fontFamily: Constants.app_font),
                            ),
                          ],
                        ),
                        Padding(
                ...
                Column(
                  ...
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Image.asset('images/ic_login_page11.png',
                      fit: BoxFit.cover,
                    )
                  ],
                )
