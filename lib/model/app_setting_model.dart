...
class Data {
  ...
  String android_customer_version;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    android_customer_version = json['android_customer_version'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['android_customer_version'] = this.android_customer_version;
